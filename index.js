...
const cors = require('cors')({
    origin: ['https://coruscating-banoffee-59fcc4.netlify.app', 'http://localhost:3000', 'http://127.0.0.1:5500', true],
...
exports.geminiProxy = onRequest({ secrets: [GEMINI_API_KEY], invoker: 'public', region: 'us-central1' }, (req, res) => {
...
exports.youtubeProxy = onRequest({ secrets: [YOUTUBE_API_KEY], invoker: 'public', region: 'us-central1' }, (req, res) => {
    return cors(req, res, async () => {
        if (req.method === 'OPTIONS') {
            return res.status(204).send('');
        }
